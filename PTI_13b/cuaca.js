  ...
  render() {
    if (this.state.tampilkan) {
      return (
          ...
          (xhttp.onload = function () {
            ...
            xhttp.open(
              ...
              "http://dataservice.accuweather.com/forecasts/v1/daily/5day/" +
                kode_kelurahan +
                "?apikey=ADLo2dGwAksDGIEqQtR9IXVlLgw2JEGJ&language=id",
              true
            );
          xhttp.send();
        }),
        xhttp.open(
          "GET",
          "http://dataservice.accuweather.com/locations/v1/cities/autocomplete?apikey=ADLo2dGwAksDGIEqQtR9IXVlLgw2JEGJ&q=" +
            kelurahan,
          true
        ),
        xhttp.send()
