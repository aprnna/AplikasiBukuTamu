...
<head>
  ...
  <link rel="stylesheet"
    href="https://unpkg.com/leaflet@1.9.4/dist/leaflet.css" integrity="sha256p4NxAoJBhIIN+hmNHrzRCf9tD/miZyoHS5obTRR9BMY=" crossorigin="" />
      ...
      if ('geolocation' in navigator) {
        navigator.geolocation.getCurrentPosition(function(position) {
          ...
          fetch(apiUrl)
            .then(response => response.json())
            .then(data => {
              var location = data.address.suburb || data.address.village ||
                data.address.town;
